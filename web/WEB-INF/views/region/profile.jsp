	...
	<div class="row">
		<div class="col-md-8">
			...
			<div class="row">
				...
				<div class="col-xs-10"><i><fmt:formatDate pattern="MM/dd/yyyy" value="${region.created}" /></i></div>
			</div>			
			<div class="row">
				<div class="col-xs-2">Area</div>
				<div class="col-xs-10"><i>${region.area}</i></div>
			</div>
			<hr/>
			<h4>Wines</h4>
			...
			<tr>
     		...
     		<tbody>
		    <c:forEach  var="wine" items="${region.wines}">
				<tr>
